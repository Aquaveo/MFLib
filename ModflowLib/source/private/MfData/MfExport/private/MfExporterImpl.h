...
const CStr ARR_DPT_ICBUNDIM = "DPT BOUNDARY ARRAY";
const CStr ARR_DPT_PHIF     = "FRACTURE POROSITY";
const CStr ARR_DPT_PRSITYIM = "IMMOBILE DOMAIN POROSITY";
const CStr ARR_DPT_BULKDIM  = "DD BULK DENSITY";
const CStr ARR_DPT_DLIM     = "DD DISPERSION COEFF.";
const CStr ARR_DPT_DDTTR    = "DD MASS TRANSFER RATE";
const CStr ARR_DPT_SIM      = "IMMOBILE DOMAIN SAT";
const CStr ARR_DPT_ADSORBIM = "DD ADSORPTION COEF";
const CStr ARR_DPT_FLICHIM  = "DD FREUNDLICH EXPONENT";
const CStr ARR_DPT_ZODRWIM  = "DD ZERO-ORDER DECAY WAT.";
const CStr ARR_DPT_ZODRSIM  = "DD ZERO-ORDER DECAY SOIL";
const CStr ARR_DPT_FODRWIM  = "DD 1-ST ORDER DECAY WAT.";
const CStr ARR_DPT_FODRS    = "DD 1-ST ORDER DECAY SOIL";
const CStr ARR_DPT_CONC     = "DPT INITIAL CONC";
...
const CStr ARR_UZF_THTR  = "RESIDUAL WATER CONTENT";
