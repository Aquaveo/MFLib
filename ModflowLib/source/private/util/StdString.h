...
// Turn off unavoidable compiler warnings
	...
	#pragma warning (disable : 4311) // aquaveo - pointer truncation
  #pragma warning (disable : 4512) // assigment operator
  #pragma warning (disable : 4996) // vs2005 warnings
#endif
...
inline PSTR StdCodeCvt(PSTR pDst, int nDst, PCSTR pSrc, int nSrc)
{
	...
	{
		pDst[0]				= '\0';
    // Begin CMS Warning fix
    //stdext::checked_array_iterator<char *> dest(pDst, _countof(pDst));
    //std::basic_string<char>::traits_type::copy(dest, pSrc, nChars);
    // End CMS
...
inline PWSTR StdCodeCvt(PWSTR pDst, int nDst, PCWSTR pSrc, int nSrc)
{
	...
	if ( nChars > 0 )
	{
		pDst[0]				= '\0';
    // Begin CMS Warning fix
    //stdext::checked_array_iterator<wchar_t *> dest(pDst, _countof(pDst));
    //std::basic_string<wchar_t>::traits_type::copy(dest, pSrc, nChars);
    // End CMS
...
//		}
    ...
    // this crashes in VS 2008 so here is a better way
    TrimRight(" \t\r\n\v\f");
    return *this;
#if 0
